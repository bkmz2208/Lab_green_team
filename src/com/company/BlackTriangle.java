...
public class BlackTriangle extends Triangle implements AbstractFactory{
    ...
    public double areaCalculation() throws Exception {
        ...
        //calculation
        double s;
        s = abs(0.5 * (double) ((super.getX1() - super.getX3()) * (super.getY2() - super.getY3()) - (super.getY1() - super.getY3()) * (super.getX2() - super.getX3())));
        return s;
    }
